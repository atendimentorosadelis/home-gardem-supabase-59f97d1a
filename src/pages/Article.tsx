...
const Article = () => {
  ...
  // URL canônica do artigo - nginx intercepta crawlers e serve OG tags
  const articleCanonicalUrl = `https://homegardenmanual.com/${dbArticle?.category_slug || categorySlug || ''}/${dbArticle?.slug || postId || ''}`;
  const encodedCanonicalUrl = encodeURIComponent(articleCanonicalUrl);
  ...
  const shareUrls = {
    ...
    twitter: `https://twitter.com/intent/tweet?text=${encodedTitle}%20-%20${encodedExcerpt}&url=${encodedCanonicalUrl}`,
    facebook: `https://www.facebook.com/sharer/sharer.php?u=${encodedCanonicalUrl}&quote=${encodedTitle}`,
