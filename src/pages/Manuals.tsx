...
const Manuals = () => {
  ...
  const posts = articles.filter(post => post.categorySlug === "diy");
      ...
      <section className="pt-16 pb-8">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-2xl space-y-4">
            ...
            <h1 className="text-4xl md:text-5xl font-display font-medium text-foreground">Manuais & DIY</h1>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Guias passo a passo completos para seus projetos de jardinagem e decoração.
            </p>
          </div>
        </div>
      </section>
